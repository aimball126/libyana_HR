        ...
        <div class="card mg-b-30">
            ...
            <div class="card-header pb-0">
                <div class="row row-xs wd-xl-400p">
                    ...
                    <div class="col-sm-6 col-md-3"><button class="btn btn-success btn-with-icon btn-block" data-toggle="modal" data-target=".bs-example-modal-center"> اضافة مقاسات للمنتج</button></div>
            ...
            <div class="card-body">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content modal-content-demo">
                            <div class="modal-header">
                                <h6 class="modal-title">إضافة مقاسات للمنتح</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                            </div>
                            <div class="modal-body">

                                <form action="<?php echo e(route('store-sizes')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $sharedDatasizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group ">
                                                        <form action="<?php echo e(route('destroy-sizes',$product->id)); ?>" method="post">
                                                            <?php echo csrf_field(); ?>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="p-3">
                                                   ...
                                                   <form action="<?php echo e(route('update-sizes',$product->id)); ?>" method="post" enctype="multipart/form-data">
                                                        <?php echo csrf_field(); ?>


                                                        <div class="form-group">
                                                            <label for="product_name">المقاس:</label>
                ...
                <?php echo e($sharedDatasizes->appends($_GET)->links()); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\libyana\resources\views\sizes\sizes.blade.php ENDPATH**/ ?>