        ...
        <div class="card mg-b-30">
            ...
            <div class="card-header pb-0">
                <div class="row row-xs wd-xl-400p">
                    ...
                    <div class="col-sm-6 col-md-3"><button class="btn btn-success btn-with-icon btn-block" data-toggle="modal" data-target=".bs-example-modal-center"> اضافة الوان للمنتج</button></div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content modal-content-demo">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="<?php echo e(route('store-colors')); ?>" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group ">
                                                        <form action="<?php echo e(route('destroy-colors',$product->id)); ?>" method="post">
                                                            <?php echo csrf_field(); ?>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="p-3">
                                                   ...
                                                   <form action="<?php echo e(route('update-colors',$product->id)); ?>" method="post" enctype="multipart/form-data">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\libyana\resources\views\colors\colors.blade.php ENDPATH**/ ?>